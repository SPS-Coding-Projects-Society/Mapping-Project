...
class SettingsState extends State<Settings> {
  ...
  bool _metricImp = false;//the following three variables should be global variables -- to be implemented later
  ...
  Widget _buildOptions() {
    return ListView(
      ...
      SwitchListTile( //Metric imperial tile
        title: Text(
        _metricImp ?  "Imperial" : "Metric",//Alternates between the two options
        style: _biggerFont),
        value: _metricImp,
        activeColor: Colors.blueGrey,
        activeTrackColor: Colors.blueGrey.shade200,
        inactiveTrackColor: Colors.blueGrey.shade200,
        inactiveThumbColor: Colors.blueGrey,//changing the track colours so they look the same when on/off since this is not an on/off switch
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(//scaffold just arranges the options nicely
      appBar: AppBar(
        title: Text('Settings'),
      ),
      body: _buildOptions(),
